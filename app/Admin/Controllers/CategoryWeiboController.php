...
class CategoryWeiboController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(WeiboCategory::class, function (Grid $grid) {
    ...
    {
        return Admin::form(WeiboCategory::class, function (Form $form) {
