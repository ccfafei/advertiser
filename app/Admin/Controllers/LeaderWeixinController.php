...
class LeaderWeixinController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(WeixinLeader::class, function (Grid $grid) {
    ...
    {
       return Admin::form(WeixinLeader::class, function (Form $form) {
